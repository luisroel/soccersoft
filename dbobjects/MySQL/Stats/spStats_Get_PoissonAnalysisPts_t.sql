DROP PROCEDURE IF EXISTS spStats_Get_PoissonAnalysisPts_t;
DELIMITER $$
CREATE PROCEDURE spStats_Get_PoissonAnalysisPts_t(
...
BEGIN
	...
	FROM 
		`vwStats_Get_PoissonProbPts_t` PP
	WHERE
