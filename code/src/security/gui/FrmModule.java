 ...
 */
public class FrmModule extends javax.swing.JInternalFrame implements ActionListener, ItemListener, ListSelectionListener {

    /**
     * Creates new form FrmObject
     */
    public FrmModule(UserRight right, Item user) {
        initComponents();
    ...
    private void loadModules(){
        if (cmbStatus.getModel().getSize() > 0) {
            ...
            lstModules.setModel(new ModuleListModel(dbModule.getList(status.getId())));
    ...
    private void deleteRecord() {
        ...
        if (ans == JOptionPane.OK_OPTION){
            String msg = dbModule.delete(Long.parseLong(txtId.getText()));
            if (!msg.isEmpty()){
