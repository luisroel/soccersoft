 ...
 */
public class FrmImportData extends javax.swing.JInternalFrame implements ActionListener{

    private String currentDir = ".";
    /**
     * Creates new form FrmUsers
     */
    public FrmImportData(UserRight right, Item user) {
        initComponents();
            ...
            switch (e.getActionCommand()) {
                ...
                case "Load":
                    try {
                        ...
                        Logger.getLogger(FrmImportData.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    break;
                case "Save":
                    saveAction();
    ...
    private void saveAction() {
        if (tblFixtures.getModel().getRowCount() > 0){
            String msg = dbFixture.importData(tblFixtures.getModel());
            if (msg.isEmpty()){
