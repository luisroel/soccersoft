...
import soccer.models.CountryListModel;

/**
 *
 * @author Administrator
 */
public class FrmCountry extends javax.swing.JInternalFrame implements ActionListener, ItemListener, ListSelectionListener {

    /**
     * Creates new form FrmCountry
     */
    public FrmCountry(UserRight right, Item user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(cmbStatus, javax.swing.GroupLayout.Alignment.LEADING, 0, 138, Short.MAX_VALUE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Country info:"));
    ...
    private void loadCountries(){
        if (cmbStatus.getModel().getSize() > 0) {
            ...
            lstCountry.setModel(new CountryListModel(dbCountry.getList(status.getId())));
            if (lstCountry.getModel().getSize() > 0){
    ...
    private void loadDetail(){
        if (!lstCountry.isSelectionEmpty()){
            Country obj = (Country)lstCountry.getSelectedValue();
    ...
    private void deleteRecord() {
        ...
        if (ans == JOptionPane.OK_OPTION){
            String msg = dbCountry.delete(Long.parseLong(txtId.getText()));
            if (!msg.isEmpty()){
