...
import soccer.database.DBMatchType;
import soccer.entities.MatchType;
import soccer.models.MatchTypeListModel;

/**
 *
 * @author Administrator
 */
public class FrmMatchType extends javax.swing.JInternalFrame implements ActionListener, ItemListener, ListSelectionListener {

    /**
     * Creates new form FrmMatchType
     */
    public FrmMatchType(UserRight right, Item user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Stat info:"));
    ...
    private int action;
    private DBMatchType dbMatchType;
    ...
    private void loadCountries(){
        if (cmbStatus.getModel().getSize() > 0) {
            ...
            lstTypes.setModel(new MatchTypeListModel(dbMatchType.getList(status.getId())));
    ...
    private void loadDetail(){
        if (!lstTypes.isSelectionEmpty()){
            MatchType obj = (MatchType)lstTypes.getSelectedValue();
    ...
    private void deleteRecord() {
        ...
        if (ans == JOptionPane.OK_OPTION){
            String msg = dbMatchType.delete(Long.parseLong(txtId.getText()));
            if (!msg.isEmpty()){
