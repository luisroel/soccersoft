 ...
 */
public class FrmPhase extends javax.swing.JInternalFrame implements ActionListener, ItemListener, ListSelectionListener {

    /**
     * Creates new form FrmPhase
     * @param right
     * @param user
     */
    public FrmPhase(UserRight right, Item user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Season Phases");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Filter:"));

        cmbStatus.setName(""); // NOI18N

        jScrollPane1.setViewportView(lstPhase);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Phase info:"));
    ...
    private void myInitComponents(UserRight right, Item user) {
        ...
        lstPhase.addListSelectionListener(this);
    ...
    private void loadCountries(){
        if (cmbStatus.getModel().getSize() > 0) {
            ...
            lstPhase.setModel(new PhaseListModel(dbPhase.getList(status.getId())));
    ...
    private void loadDetail(){
        if (!lstPhase.isSelectionEmpty()){
            Phase obj = (Phase)lstPhase.getSelectedValue();
    ...
    private void deleteRecord() {
        ...
        if (ans == JOptionPane.OK_OPTION){
            String msg = dbPhase.delete(Long.parseLong(txtId.getText()));
            if (!msg.isEmpty()){
