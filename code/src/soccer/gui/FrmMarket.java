...
import soccer.database.DBMarket;
import soccer.entities.Market;
import soccer.models.MarketListModel;

/**
 *
 * @author Administrator
 */
public class FrmMarket extends javax.swing.JInternalFrame implements ActionListener, ItemListener, ListSelectionListener {

    /**
     * Creates new form FrmMarket
     */
    public FrmMarket(UserRight right, Item user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lstMarket = new javax.swing.JList();
        ...
        jScrollPane1.setViewportView(lstMarket);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Market info:"));
    ...
    private javax.swing.JList lstMarket;
    ...
    private void myInitComponents(UserRight right, Item user) {
        ...
        lstMarket.addListSelectionListener(this);
    ...
    private void loadCountries(){
        if (cmbStatus.getModel().getSize() > 0) {
            ...
            lstMarket.setModel(new MarketListModel(dbMarket.getList(status.getId())));
            if (lstMarket.getModel().getSize() > 0){
                lstMarket.setSelectedIndex(0);
            } else {
                // clear data fields
                clearFields();
            }
    ...
    private void loadDetail(){
        if (!lstMarket.isSelectionEmpty()){
            Market obj = (Market)lstMarket.getSelectedValue();
    ...
    private void deleteRecord() {
        ...
        if (ans == JOptionPane.OK_OPTION){
            String msg = dbMarket.delete(Long.parseLong(txtId.getText()));
            if (!msg.isEmpty()){
