...
import soccer.database.DBFixtureType;
import soccer.entities.FixtureType;
import soccer.models.FixtureTypeListModel;

/**
 *
 * @author Administrator
 */
public class FrmFixtureType extends javax.swing.JInternalFrame implements ActionListener
                                                                        , ItemListener
                                                                        , ListSelectionListener {

    /**
     * Creates new form FrmMatchType
     */
    public FrmFixtureType(UserRight right, Item user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Fixture type info:"));
    ...
    private int action;
    private DBFixtureType dbFixtureType;
    ...
    private void myInitComponents(UserRight right, Item user) {
        ...
        dbFixtureType = new DBFixtureType();
    ...
    private void loadList(){
        if (cmbStatus.getModel().getSize() > 0) {
            ...
            lstTypes.setModel(new FixtureTypeListModel(dbFixtureType.getList(status.getId())));
    ...
    private void loadDetail(){
        if (!lstTypes.isSelectionEmpty()){
            FixtureType obj = (FixtureType)lstTypes.getSelectedValue();
    ...
    private String insertRecord() {
        FixtureType obj = new FixtureType(
              -1
            , txtName.getText()
        ...
        return dbFixtureType.insert(obj);
    }
    ...
    private String updateRecord() {
        ...
        return dbFixtureType.update(obj);
    }
    ...
    private void deleteRecord() {
        ...
        if (ans == JOptionPane.OK_OPTION){
            String msg = dbFixtureType.delete(Long.parseLong(txtId.getText()));
            if (!msg.isEmpty()){
